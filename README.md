...
* echttp_print reformats the content of the JSON files provided and prints that reformated data. By default the output is pretty-printed; if the -r option is used, the output is generated as a single line with no space between JSON elements.
